            ...
            <div class="judul">
                ...
                <div class="keterangan1">
                    <table>
                        ...
                        <tr>
                            <td class="ket1">KECAMATAN</td>
                            <td class="titik_dua">:</td>
                            <td class="ket2">'.$kecamatan.'</td>
                        </tr>
                    </table>
                </div>
                <div class="keterangan2">
                    <table>
                        <tr>
                            <td class="ket1r">BULAN</td>
                            <td class="titik_dua">:</td>
                            <td class="ket2r">'.$bulan.'</td>
                        </tr>
                        <tr>
...
$mpdf->Output('laporan-padi.pdf', \Mpdf\Output\Destination::INLINE);