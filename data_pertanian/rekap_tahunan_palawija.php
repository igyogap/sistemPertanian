 ...
 include '../user/nav_pegawai.php'; ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div
            ...
            <h2>Rekap Data Palawija</b></h2><br>
        ...
        <?php 
            ...
            $kecamatan = $_GET['kecamatan'];
            $tahun = $_GET['tahun'];
            echo '<a href="../laporan/cetak_tahunan_palawija.php?filter=&kecamatan='.$kecamatan.'&tahun='.$tahun.'">Cetak PDF <span class="fa fa-file-pdf-o"></a><br /><br />';
