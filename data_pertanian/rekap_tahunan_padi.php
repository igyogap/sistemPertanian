 ...
 include '../user/nav_pegawai.php'; ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <div class="form-row align-items-center">
                ...
                <div class="form-grup col-md-3">
                    ...
                    <select name="kecamatan" id="kecamatan" class="form-control">
                        ...
                        <option value="Denpasar Selatan" <?php if ($kecamatan=="Denpasar Selatan" ){ echo "selected" ; }
                            ?>>Denpasar Selatan</option>
        ...
        <?php 
            ...
            $kecamatan = $_GET['kecamatan'];
            $tahun = $_GET['tahun'];
            echo '<a href="../laporan/cetak_tahunan_padi.php?filter=&kecamatan='.$kecamatan.'&tahun='.$tahun.'">Cetak PDF <span class="fa fa-file-pdf-o"></a><br /><br />';
            

            $query = "SELECT id_nm_padi, SUM(bulanlalu) AS bulanlalu,
                                                SUM(panen) AS panen,
                                                SUM(tanam) AS tanam,
                                                SUM(puso) AS puso,
                        ...
                        FROM tb_padi 
                        WHERE  kecamatan='$kecamatan' AND tahun='$tahun'  
                        GROUP BY id_nm_padi
                        ORDER BY id_nm_padi ASC";
        ...
        <table id="tablePreview" class="table table-hover table-sm table-bordered text-center">
            ...
            <tr>
                ...
                <?php 
                    $sql = mysqli_query($con,"SELECT * FROM tb_nm_padi");
                    while ($data = mysqli_fetch_assoc($sql)) {
                        if ($row['id_nm_padi']== $data['id_nm_padi']) {
                            $nama = $data['nama'];
                            echo"<td>$nama</td>";
                        }
                    }
