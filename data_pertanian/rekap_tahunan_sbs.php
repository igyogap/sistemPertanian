 ...
 include '../user/nav_pegawai.php'; ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <?php 
            ...
            $kecamatan = $_GET['kecamatan'];
            $tahun = $_GET['tahun'];
            echo '<a href="../laporan/cetak_tahunan_sbs.php?filter=&kecamatan='.$kecamatan.'&tahun='.$tahun.'">Cetak PDF <span class="fa fa-file-pdf-o"></a><br /><br />';
            

            $query = "SELECT id_nm_sbs, SUM(bulanlalu) AS bulanlalu,
                                                SUM(panen) AS panen,
                                                SUM(tanam) AS tanam,
                                                SUM(puso) AS puso,
        ...
        <table id="tablePreview" class="table table-hover table-sm table-bordered text-center">
            ...
            <tr>
                ...
                <?php 
                    $sql = mysqli_query($con,"SELECT * FROM tb_nm_sbs");
                    while ($data = mysqli_fetch_assoc($sql)) {
                        if ($row['id_nm_sbs']== $data['id_nm_sbs']) {
                            $nama = $data['nama'];
                            echo"<td>$nama</td>";
                        }
                    }
