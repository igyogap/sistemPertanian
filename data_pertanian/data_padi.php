 ...
 include '../user/nav_pegawai.php'; ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <!-- akhir tombol select -->
            ...
            $bulan = $_GET ['bulan'];
            $tahun = $_GET['tahun'];
            echo '<a href="../laporan/cetak_bulanan.php?filter=&kecamatan='.$kecamatan.'&bulan='.$bulan.'&tahun='.$tahun.'">Cetak PDF <span class="fa fa-file-pdf-o"></a><br /><br />';

            $query = "SELECT * FROM tb_padi WHERE  kecamatan='$kecamatan' AND bulan='$bulan' AND tahun='$tahun' ORDER BY id_nm_padi ASC";
