<?php 
    ...
    if (isset( $_POST['tambah-padi'])) {
        
        if (tambah_padi($_POST)>0) {
            echo"
        <script>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="text-center">
            ...
            <button type="button" class="btn btn-primary rounded-pill shadow" data-toggle="modal"
                data-target="#modal-add" data-role="add_padi">Tambah Data Padi
        ...
        <table id="tablePreview" class="table table-hover table-sm table-bordered text-center" onclick="tabeltxt()">
            ...
            $query = "SELECT * FROM tb_padi WHERE  kecamatan LIKE ? AND bulan LIKE ? AND tahun LIKE ?";
            $data = $con->prepare($query);
            $data->bind_param('sss',$s_kecamatan, $s_bulan, $s_tahun);
            $data->execute();
            $padi = $data->get_result();
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="update_padi.php?id_padi=<?= $row["id_padi"] ?>"">
                <span class=" fa fa-pencil-square-o"></span>
                    </a>
                    <a href="delete_padi.php?id_padi=<?= $row["id_padi"] ?>"
