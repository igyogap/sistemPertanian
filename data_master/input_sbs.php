<?php 
    ...
    if (isset( $_POST['tambah-sbs'])) {

       if (tambah_sbs($_POST)>0) {
            echo"
        <script>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="text-center">
            ...
            <button type="button" class="btn btn-primary rounded-pill shadow" data-toggle="modal"
                data-target="#modal-add" data-role="add_sbs">Tambah Data sbs
        ...
        <table id="tablePreview" class="table table-hover table-sm table-bordered text-center" onclick="tabeltxt()">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="update_sbs.php?id_sbs=<?= $row["id_sbs"] ?>"">
                <span class=" fa fa-pencil-square-o"></span>
                    </a>
                    <a href="delete_sbs.php?id_sbs=<?= $row["id_sbs"] ?>"
