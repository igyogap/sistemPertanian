<?php 
    ...
    $palawija = query("SELECT * FROM tb_palawija WHERE id_palawija = $id")[0];
 ...
 include '../user/nav_admin.php'; ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div
            ...
            <h2>Ubah Data Palawija</b></h2><br>

        </div><br>

        <form action="" method="POST">
            <input type="hidden" name="id_palawija" value="<?= $palawija["id_palawija"];?>">
            <div class="form-group row">

                <div class="col-2">
                    <?php $result = mysqli_query($con, "SELECT * FROM tb_palawija WHERE id_palawija='$id'");
            ...
            <div class="form-group row">
                <div class="col-1"><label for="id_nm_palawija">Uraian</label></div>
                <div class="form-grup col-5">

                    <select name="id_nm_palawija" id="id_nm_palawija" class="form-control">
                        <?php $sql = mysqli_query($con, "SELECT * FROM tb_nm_palawija");
                            while ($data = mysqli_fetch_assoc($sql)) {
                                if ($palawija['id_nm_palawija']==$data['id_nm_palawija']) {
                                $select="selected";
                                }else{
                                $select="";
                                }
                                $id = $data['id_nm_palawija'];
                                $nama = $data['nama'];
            ...
            <div class="form-group row">
                ...
                <div class="col-5">
                    <input type="number" class="form-control" name="bulanlalu" id="bulanlalu"
                        value="<?= $palawija['bulanlalu']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="panen" class="col-sm-1 col-form-label">Panen</label>
                <div class="col-5">
                    <input type="number" class="form-control" name="panen" id="panen" value="<?= $palawija['panen']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="tanam" class="col-sm-1 col-form-label">Tanam</label>
                <div class="col-5">
                    <input type="number" class="form-control" name="tanam" id="tanam" value="<?= $palawija['tanam']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="puso" class="col-sm-1 col-form-label">Puso</label>
                <div class="col-5">
                    <input type="number" class="form-control" name="puso" id="puso" value="<?= $palawija['puso']; ?>">
                </div>
            </div><br>
            <div class="col-6 text-center">
            ...
            <div class="form-group row">
                ...
                <div class="col-5">
                    <input type="number" class="form-control" name="bstanam" id="bstanam"
                        value="<?= $palawija['bstanam']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="bspuso" class="col-sm-1 col-form-label">Puso</label>
                <div class="col-5">
                    <input type="number" class="form-control" name="bspuso" id="bspuso" value="<?= $palawija['bspuso']; ?>">
                </div>
            </div><br>
