<?php 
    ...
    $sbs = query("SELECT * FROM tb_sbs WHERE id_sbs = $id")[0];
 ...
 include '../user/nav_admin.php'; ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div
            ...
            <h2>Ubah Data SBS</b></h2><br>

        </div><br>

        <form action="" method="POST">
            <input type="hidden" name="id_sbs" value="<?= $sbs["id_sbs"];?>">
            <div class="form-group row">

                <div class="col-2">
                    <?php $result = mysqli_query($con, "SELECT * FROM tb_sbs WHERE id_sbs='$id'");
            ...
            <div class="form-group row">
                <div class="col-1"><label for="id_nm_sbs">Uraian</label></div>
                <div class="form-grup col-5">

                    <select name="id_nm_sbs" id="id_nm_sbs" class="form-control">
                        <?php $sql = mysqli_query($con, "SELECT * FROM tb_nm_sbs");
                            while ($data = mysqli_fetch_assoc($sql)) {
                                if ($sbs['id_nm_sbs']==$data['id_nm_sbs']) {
                                $select="selected";
                                }else{
                                $select="";
                                }
            ...
            <div class="form-group row">
                ...
                <div class="col-5">
                    <input type="number" class="form-control" name="panen" id="panen" value="<?= $sbs['panen']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="tanam" class="col-sm-1 col-form-label">Tanam</label>
                <div class="col-5">
                    <input type="number" class="form-control" name="tanam" id="tanam" value="<?= $sbs['tanam']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="puso" class="col-sm-1 col-form-label">Puso</label>
                <div class="col-5">
                    <input type="number" class="form-control" name="puso" id="puso" value="<?= $sbs['puso']; ?>">
                </div>
            </div><br>
            <div class="col-6 text-center">
            ...
            <div class="form-group row">
                ...
                <div class="col-5">
                    <input type="number" class="form-control" name="bspuso" id="bspuso" value="<?= $sbs['bspuso']; ?>">
                </div>
            </div><br>
