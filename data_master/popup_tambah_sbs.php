    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Tambah data sbs</h5>
            ...
            <form action="" method="POST" class="">
                ...
                <div class="form-grup col-md-4">
                    ...
                    <h5 class="text-center">Masukan Data sbs</h5>
                    <div class="row">
                    ...
                    <select name="uraian" id="uraian" class="form-control">
                        ...
                        <option value="<?= $data['id_nm_sbs'] ?>"><?= $data['nama'] ?></option>
                        <?php } ?>
                    </select>
                    </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="tambah-sbs" class="btn btn-primary">Tambah</button>
                </div>
            </form>
        </div>
    </div>
